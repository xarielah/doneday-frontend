...
const GroupPreRow = ({ group, crudlType, task = {}, roundedTopLeft, roundedBottomLeft, bottomBorders, isChecked, onCheckBox, disableCheckbox, ligherColor = false }) => {
    ...
    return <>
        ...
        <div className="task-left-indicator" style={{ ...topLeft, ...bottomLeft, border: 'none', background: group.color, opacity: ligherColor ? '0.5' : '1' }}></div>
